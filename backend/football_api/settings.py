...
ALLOWED_HOSTS = [
    'live-football-app-backend.onrender.com',
    'render.com',
    'localhost',
    '127.0.0.1',
    '*'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Live Football API',
    'DESCRIPTION': 'API for live football match data using Football-Data.org',
    'VERSION': '1.0.0',
...
ALL_AVAILABLE_COMPETITIONS_PATH = config('ALL_AVAILABLE_COMPETITIONS_PATH', default='')
ALL_AREA_PATH = config('ALL_AREA_PATH', default='')
